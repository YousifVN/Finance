...
def buy():
    ...
    if request.method == "POST":
        ...
        if cash < total_price:
            ...
            db.execute("INSERT INTO transactions (user_id, shares, price, type, symbol) VALUES (? , ?, ?, ?, ?)", user_id, shares, item_price, "buy", symbol)
...
def sell():
    ...
    if request.method == "POST":
        ...
        if shares <= 0:
            return apology("Shares must be a positive a number")
        ...
        db.execute("INSERT INTO transactions (user_id, shares, price, type, symbol) VALUES (?, ?, ?, ?, ?)", user_id, -shares, item_price, "sell", symbol)
